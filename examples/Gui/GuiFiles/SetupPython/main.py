...
def import_documents():
    with open(os.path.join(data_path, 'BaseClasses_pages.py')) as f: base_classes = f.read()
...
def setup_loading_screen(gui):
    ...
    bar, bar_rect = load_image('loadingcircle.png', data_path, colorkey = -1, size = [100,100])
